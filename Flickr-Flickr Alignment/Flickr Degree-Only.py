...
def reordering_by_deg(ordered_degree_list, dn_map, some_sub, new_list):
    for degree in ordered_degree_list:
        node_list = dn_map[degree]
        sub_nodes_graph = some_sub.subgraph(node_list)
        degrees = list(sub_nodes_graph.nodes())
        for node in degrees:
...
for percentage in percentages:
    ...
    flickr_new_1 = []
    flickr_new_1 = reordering_by_deg(degree_ordered_1, map_flickr_1, flickr_sub_1, flickr_new_1)
    print("Flickr_1 node reordering done.")

    flickr_new_2 = []
    flickr_new_2 = reordering_by_deg(degree_ordered_2, map_flickr_2, flickr_sub_2, flickr_new_2)
