...
def generate_results_table(results, precision_half_list, num_nodes_list):
    ...
    table += "\n\\end{tabular}\n\\caption{Correct Percentage for Flickr and Flickr Degree Matrices Alignment}\n\\end{table}"
    return table


# Load the graphs
mygraph_flickr = create_sample_graph("/Path/to/flickr.edges",
                                     "/Path/to/flickr.nodes")
...
num_nodes_list = [3500, 3750, 4000, 4250, 4500, 4750]
